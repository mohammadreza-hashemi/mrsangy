...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.acl.all',['permissions'=>$permission]);
    ...
    public function store(Request $request)
    {
        ...
        alert()->success('permission successfully inserted','STORED')->persistent('مرسی   ');
    ...
    public function syncview(){
        ...
        return view('admin.acl.syncpermission');
    }
